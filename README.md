# ⛓ OpenHash Jeju City Node

![Layer](https://img.shields.io/badge/Layer-2-blue)
...
| 항목 | 값 |
|---|---|
| Node ID | `KR-JEJU-JEJU` |
| Layer | L2 — Jeju City |
| Endpoint | `https://nounweb.github.io/openhash-L2-jeju-city` |
...
curl -X POST \
  ...
  https://api.github.com/repos/nounweb/openhash-L2-jeju-city/dispatches \
  -d '{
